...
class CloneBot < Ebooks::Bot
  ...
  def configure
    ...
    self.consumer_key = "uCJK9UrJDHAO4nabMtTCnNFZU"
    self.consumer_secret = "csYi9lrk54Y9oUYwHpETKLxCkUugcv9wjv5TxmE6WACOpSHM0P"
    self.blacklist = ['salielle', 'freyasspirit', 'armlesskittyfox', 'MoonlitSystem', 'MoonlitEmma', 'MoonlitAerie', 'PenemueLibrary', 'pixstellation']
...
CloneBot.new("ezmybooks") do |bot|
  bot.access_token = "2952804687-z7FAQdybj3sCwM434Xo4HYFS5ijGqOuZGwtRZ9b"
  bot.access_token_secret = "9YmLfmt5CeMxLn7nXs0s6nSgn1jFAUjxDde19jZf7XzNH"

  bot.original = "Ezmyrelda"
